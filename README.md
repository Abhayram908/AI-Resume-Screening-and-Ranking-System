...
This project is an AI-powered resume screening and ranking system built using Streamlit, scikit-learn, and PyPDF2. The application allows users to upload resumes in PDF format, compares them to a given job description, and ranks them.
...
git clone https://github.com/Abhayram908/AI-Resume-Screening-and-Ranking-System.git
...
Activate on Windows: source .myenv\Scripts\activate

Activate on Mac/Linux: source .myenv/bin/activate
